...
(function(){
  ...
  var ADS = [
    ...
    { emoji:'📖', title:'120 Original Stories',  body:'Dive into a brand-new adventure at the Story Hub.',           cta:'Read now',   url:'/stories/index.html',   bg:'linear-gradient(135deg,#1b6a9a,#4dc0cc)' },
    { emoji:'🤖', title:'150 Free AI Tools',    body:'Fancy text, ciphers, converters & more — all in your browser.', cta:'Try them',  url:'/ai-tools/index.html',  bg:'linear-gradient(135deg,#9a1b5c,#e05b8a)' },
