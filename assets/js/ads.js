...
(function(){
  ...
  var ADS = [
    ...
    { emoji:'📖', title:'170 Original Stories',  body:'Dive into a brand-new adventure at the Story Hub.',           cta:'Read now',   url:'/stories/index.html',   bg:'linear-gradient(135deg,#1b6a9a,#4dc0cc)' },
