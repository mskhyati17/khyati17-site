...
(function(){
  ...
  var ADS = [
    ...
    { emoji:'🤖', title:'125 Free AI Tools',    body:'Fancy text, ciphers, converters & more — all in your browser.', cta:'Try them',  url:'/ai-tools/index.html',  bg:'linear-gradient(135deg,#9a1b5c,#e05b8a)' },
