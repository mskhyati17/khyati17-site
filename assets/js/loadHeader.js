export async function loadSharedHeader(){
  try{
    ...
    try{ if(!document.getElementById('cute-loader')){ const cs=document.createElement('script'); cs.id='cute-loader'; cs.src='/assets/js/cute.js?v=2'; document.body.appendChild(cs); } }catch(e){/* ignore */}
