...
(function(){
  ...
  var ADS = [
    ...
    { emoji:'📖', title:'1,000+ Original Stories', body:'Dive into a brand-new adventure at the Story Hub.',           cta:'Read now',   url:'/stories/index.html',   bg:'linear-gradient(135deg,#1b6a9a,#4dc0cc)' },
    ...
    { emoji:'🎬', title:'Fun Videos & Shorts',  body:'Kick back and watch something fun.',                          cta:'Watch now',  url:'/videos/index.html',   bg:'linear-gradient(135deg,#9a5c1b,#e0a24d)' },
